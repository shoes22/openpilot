...
def data_send(sm, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate,
              ...
              LaC, LoC, read_only, start_time, v_acc, a_acc, lac_log, events_prev, set_follow_distance, keep_this_speed, update_speed_limit):
...
def controlsd_thread(gctx=None):
  ...
  while True:
    ...
    actuators, v_cruise_kph, driver_status, v_acc, a_acc, lac_log, set_follow_distance = \
    ...
    CC, events_prev = data_send(sm, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate, carcontrol, carevents, carparams,
                   controlsstate, sendcan, AM, driver_status, LaC, LoC, read_only, start_time, v_acc, a_acc, lac_log, events_prev, set_follow_distance, keep_this_speed, update_speed_limit)
