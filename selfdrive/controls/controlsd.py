...
#      rear_view_toggle = not rear_view_toggle
  ...
  return actuators, v_cruise_kph, v_acc_sol, a_acc_sol, lac_log, last_blinker_frame, saturated_count, set_follow_distance
...
def data_send(sm, pm, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, AM,
              ...
              last_blinker_frame, is_ldw_enabled, set_follow_distance, keep_this_speed, update_speed_limit, can_error_counter):
...
def controlsd_thread(sm=None, pm=None, can_sock=None):
  ...
  while True:
    ...
    actuators, v_cruise_kph, v_acc, a_acc, lac_log, last_blinker_frame, saturated_count, set_follow_distance = \
    ...
    CC, events_prev = data_send(sm, pm, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, AM, LaC,
                                ...
                                is_ldw_enabled, set_follow_distance, keep_this_speed, update_speed_limit, can_error_counter)
