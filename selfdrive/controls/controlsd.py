...
#      rear_view_toggle = not rear_view_toggle
  ...
  return actuators, v_cruise_kph, v_acc_sol, a_acc_sol, lac_log, last_blinker_frame, set_follow_distance
...
def controlsd_thread(sm=None, pm=None, can_sock=None):
  ...
  while True:
    ...
    actuators, v_cruise_kph, v_acc, a_acc, lac_log, last_blinker_frame, set_follow_distance = \
