...
#      rear_view_toggle = not rear_view_toggle
  ...
  return actuators, v_cruise_kph, driver_status, angle_offset, set_follow_distance, v_acc_sol, a_acc_sol
...
def data_send(plan, path_plan, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate,
              ...
              LaC, LoC, angle_offset, passive, start_time, set_follow_distance, params, v_acc, a_acc):
...
def controlsd_thread(gctx=None, rate=100):
  ...
  while True:
    ...
    actuators, v_cruise_kph, driver_status, angle_offset, set_follow_distance, v_acc, a_acc = \
    ...
    CC = data_send(plan, path_plan, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate, carcontrol,
                   live100, AM, driver_status, LaC, LoC, angle_offset, passive, start_time, set_follow_distance, params, v_acc, a_acc)
