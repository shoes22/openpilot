...
#      rear_view_toggle = not rear_view_toggle
  ...
  return actuators, v_cruise_kph, driver_status, angle_model_bias, v_acc_sol, a_acc_sol, lac_log, set_follow_distance
...
def data_send(plan, path_plan, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate,
              ...
              LaC, LoC, angle_model_bias, read_only, start_time, v_acc, a_acc, lac_log, set_follow_distance, keep_this_speed, update_speed_limit):
...
def controlsd_thread(gctx=None):
  ...
  while True:
    ...
    actuators, v_cruise_kph, driver_status, angle_model_bias, v_acc, a_acc, lac_log, set_follow_distance = \
    ...
    CC = data_send(plan, path_plan, CS, CI, CP, VM, state, events, actuators, v_cruise_kph, rk, carstate, carcontrol,
                   controlsstate, sendcan, AM, driver_status, LaC, LoC, angle_model_bias, read_only, start_time, v_acc, a_acc, lac_log, set_follow_distance, keep_this_speed, update_speed_limit)
