...
HUDData = namedtuple("HUDData",
                     ["pcm_accel", "v_cruise", "update_speed", "car", "lanes", "fcw", "acc_alert", "steer_required", "show_lines", "follow_lines"])
...
class CarController():
  ...
  def update(self, enabled, CS, frame, actuators,
             ...
             update_speed, hud_v_cruise, hud_show_lanes, hud_show_car, hud_follow_distance, hud_alert):
    ...
    hud = HUDData(int(pcm_accel), int(round(hud_v_cruise)), update_speed, hud_car,
                  hud_lanes, fcw_display, acc_alert, steer_required, enable_lines, hud_lines)
